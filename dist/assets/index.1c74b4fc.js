...
const login$1 = "";
const coracaoUrl = "data:image/png;base64,";
const bemSocialUrl = "data:image/png;base64,";
/**
 * @license
...
const realizarLogin = (email, password) => signInWithEmailAndPassword(auth, email, password).then((userCredential) => userCredential.user).catch((error) => error.message);
const salvarPost = async (message) => {
...
const excluirPostagem = async (postId) => {
  ...
  if (postsSnapshot.exists()) {
    ...
    if (post.userId === userId) {
      ...
      mensagemElement.textContent = "Postagem exclu\xEDda com sucesso.";
      return true;
    }
    mensagemElement.textContent = "Voc\xEA n\xE3o tem permiss\xE3o para excluir esta postagem.";
    return false;
  }
};
const login = () => {
...
`;
  ...
  const mensagemElement2 = containerLogin.querySelector("#mensagem");
  ...
  botaoEntrar.addEventListener("click", async () => {
    ...
    if (typeof user === "string") {
      mensagemElement2.innerHTML = "E-mail ou senha incorretos.";
    } else {
...
const card = (mensagem, timestamp, postId, userId) => {
  ...
  deleteButton.addEventListener("click", async (event) => {
    const result = await excluirPostagem(postId);
    if (result === true) {
...
const feed = () => {
  ...
  const printarPost = async () => {
    ...
    posts.forEach((post) => {
      const novoCard = card(post.mensagem, post.timestamp, post.id);
